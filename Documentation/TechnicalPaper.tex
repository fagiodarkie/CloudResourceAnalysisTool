...
The method itself is typed as $[peak, net], R$ where:
\begin{itemize}
\item $peak$ is the maximum number of virtual machines created within the method;
\item $net$ is the number of virtual machines that are active when the method ends. It may be negative if the method releases more virtual machines than the ones it creates.
